...
@section('content')
	...
	<div class="panel panel-warning">
		<div class="panel-heading"><h3 class="panel-title">Gruppe bearbeiten</h3></div>
		{!! Form::model($role, array('route' => ['role.update', $role->id], 'method' => 'post', 'class' => 'panel-body')) !!}
		<div class="row">
			<div class="col-md-2">
				<div class="form-group">
					{!! Form::select('permissions',array_combine(\A3LWebInterface\Permission::orderBy('id')->lists('id'),\A3LWebInterface\Permission::orderBy('id')->lists('name')),$role->perms->lists('id'),array('name'=>'permissions[]','multiple'=>'multiple','class'=>'form-control','style'=>'height:132px')) !!}
				</div>
			</div>
			<div class="col-md-5">
			...
			<div class="col-md-1">
				<a href="{{ url('/role/list') }}" class="btn btn-block btn-default">abbrechen</a>
			</div>
			<div class="col-md-1">
	...
	<div class="panel panel-info">
		...
		<table class="table table-hover" data-order='[[ 0, "desc" ]]'>
			...
			@foreach(\A3LWebInterface\Weblog::where('object_id', $role->id)->where('table', 'roles')->get() as $log)
				<tr>
