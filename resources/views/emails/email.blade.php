...
<head>
	...
	<style type="text/css">
		...
		@import url(https://fonts.googleapis.com/css?family=Open+Sans:400italic,700italic,700,400);
		body,.wrapper,.emb-editor-canvas{background-color:#fff}.border{background-color:#888888}h1{color:#262626}.wrapper h1{}.wrapper h1{font-family:Tahoma,sans-serif}@media only screen and (min-width: 0){.wrapper h1{font-family:Roboto,Tahoma,sans-serif !important}}h1{}.one-col h1{line-height:44px}.two-col h1{line-height:34px}.three-col h1{line-height:26px}.wrapper .one-col-feature h1{line-height:58px}@media only screen and (max-width: 620px){h1{line-height:44px !important}}h2{color:#262626}.wrapper h2{}.wrapper h2{font-family:Tahoma,sans-serif}@media only screen and (min-width: 0){.wrapper h2{font-family:Roboto,Tahoma,sans-serif !important}}h2{}.one-col h2{line-height:34px}.two-col h2{line-height:26px}.three-col h2{line-height:22px}.wrapper .one-col-feature h2{line-height:50px}@media only screen and (max-width: 620px){h2{line-height:34px !important}}h3{color:#262626}.wrapper h3{}.wrapper h3{font-family:Georgia,serif}h3{}.one-col h3{line-height:26px}.two-col h3{line-height:22px}.three-col h3{line-height:20px}.wrapper .one-col-feature h3{line-height:42px}@media only screen and (max-width: 620px){h3{line-height:26px !important}}p,ol,ul{color:#262626}.wrapper p,.wrapper ol,.wrapper ul{}.wrapper p,.wrapper ol,.wrapper ul{font-family:sans-serif}@media only screen and (min-width: 0){.wrapper p,.wrapper ol,.wrapper ul{font-family:"Open Sans",sans-serif !important}}p,ol,ul{}.one-col p,.one-col ol,.one-col ul{line-height:25px;Margin-bottom:25px}.two-col p,.two-col ol,.two-col ul{line-height:22px;Margin-bottom:22px}.three-col p,.three-col ol,.three-col ul{line-height:20px;Margin-bottom:20px}.wrapper .one-col-feature p,.wrapper .one-col-feature ol,.wrapper .one-col-feature ul{line-height:32px}.one-col-feature blockquote p,.one-col-feature blockquote ol,.one-col-feature blockquote ul{line-height:50px}@media only screen and (max-width: 620px){p,ol,ul{line-height:25px !important;Margin-bottom:25px !important}}.image{color:#262626}.image{font-family:sans-serif}@media only screen and (min-width: 0){.image{font-family:"Open Sans",sans-serif !important}}.wrapper a{color:#237986}.wrapper a:hover{color:#18545e !important}.wrapper .logo div{color:#237986}.wrapper .logo div{font-family:sans-serif}@media only screen and (min-width: 0){.wrapper .logo div{font-family:Avenir,sans-serif
		!important}}.wrapper .logo div a{color:#237986}.wrapper .logo div a:hover{color:#237986 !important}.wrapper .one-col-feature p a,.wrapper .one-col-feature ol a,.wrapper .one-col-feature ul a{border-bottom:1px solid #237986}.wrapper .one-col-feature p a:hover,.wrapper .one-col-feature ol a:hover,.wrapper .one-col-feature ul a:hover{color:#18545e !important;border-bottom:1px solid #18545e !important}.btn a{}.wrapper .btn a{}.wrapper .btn a{font-family:sans-serif}@media only screen and (min-width: 0){.wrapper .btn a{font-family:"Open Sans",sans-serif !important}}.wrapper .btn a{background-color:#237986;color:#fff !important;outline-color:#237986;text-shadow:0 1px 0 #206d79}.wrapper .btn a:hover{background-color:#206d79 !important;color:#fff !important;outline-color:#206d79 !important}.preheader .title,.preheader .webversion,.footer .padded{color:silver}.preheader .title,.preheader
		.webversion,.footer .padded{font-family:sans-serif}@media only screen and (min-width: 0){.preheader .title,.preheader .webversion,.footer .padded{font-family:"Open Sans",sans-serif !important}}.preheader .title a,.preheader .webversion a,.footer .padded a{color:silver}.preheader .title a:hover,.preheader .webversion a:hover,.footer .padded a:hover{color:#9a9a9a !important}.footer .social .divider{color:#888888}.footer .social .social-text,.footer .social a{color:silver}.wrapper .footer .social .social-text,.wrapper .footer .social a{}.wrapper .footer .social .social-text,.wrapper .footer .social a{font-family:sans-serif}@media only screen and (min-width: 0){.wrapper .footer .social .social-text,.wrapper .footer .social a{font-family:"Open Sans",sans-serif !important}}.footer .social .social-text,.footer .social a{}.footer .social .social-text:hover,.footer .social a:hover{color:#9a9a9a !important}.image .border{background-color:#c8c8c8}.image-frame{background-color:#dadada}.image-background{background-color:#f7f7f7}
	</style>
	<!--[if gte mso 9]>
	<style>
		.column-top {
...
<body style="margin: 0;mso-line-height-rule: exactly;padding: 0;min-width: 100%;background-color: #fff">
...
<center class="wrapper" style="display: table;table-layout: fixed;width: 100%;min-width: 620px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #fff">
	...
	<table class="header centered" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;width: 602px">
		...
		<tr>
			<td class="logo" style="padding: 32px 0;vertical-align: top;mso-line-height-rule: at-least">
				<div class="logo-center" style="font-size: 26px;font-weight: 700;letter-spacing: -0.02em;line-height: 32px;color: #237986;font-family: sans-serif;text-align: center" align="center" id="emb-email-header">Arma 3 Altis Life WebInterface</div>
			</td>
		</tr>
		</tbody>
	</table>
	<table class="border" style="border-collapse: collapse;border-spacing: 0;font-size: 10px;line-height: 10px;background-color: {{ isset($color) ? $color : '#888888' }};Margin-left: auto;Margin-right: auto" width="602">
		<tbody>
		<tr>
	...
	<table class="centered" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto">
		<tbody>
		<tr>
			<td class="border" style="padding: 0;vertical-align: top;font-size: 1px;line-height: 1px;background-color: #888888;width: 1px">&#8203;</td>
			<td style="padding: 0;vertical-align: top">
	...
	<table class="border" style="border-collapse: collapse;border-spacing: 0;font-size: 1px;line-height: 1px;background-color: #888888;Margin-left: auto;Margin-right: auto" width="602">
		<tbody>
		<tr>
			<td style="padding: 0;vertical-align: top">&#8203;</td>
		</tr>
					...
					<tr>
						<td class="address" style="padding: 0;vertical-align: top;width: 250px;padding-top: 32px;padding-bottom: 64px">
							<table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
								<tbody>
								<tr>
									<td class="padded" style="padding: 0;vertical-align: top;padding-left: 0;padding-right: 10px;word-break: break-word;word-wrap: break-word;text-align: left;font-size: 12px;line-height: 20px;color: silver;font-family: sans-serif">
										<div>
											Arma 3 Altis Life WebInterface
											<br />
