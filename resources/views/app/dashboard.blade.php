        ...
        <li class="masonry-item">
            <div class="widget">
                <div class="widget-content padding-30 bg-brown-600 clearfix">
                    <div class="counter counter-md pull-left text-left counter-inverse">
                        <div class="counter-number-group">
                            <span class="counter-number">{{ $a3e['vehicle_count'] }}</span>
                            <span class="counter-number-related text-capitalize">Fahrzeuge</span>
                        </div>
                        <div class="counter-label font-size-16">Exile</div>
                    </div>
        ...
        <li class="masonry-item">
            <div class="widget">
                <div class="widget-content padding-30 bg-brown-600 clearfix">
                    <div class="counter counter-md pull-left text-left counter-inverse">
                        <div class="counter-number-group">
                            <span class="counter-number">{{ format_int($a3e['money_sum']) }}</span>
        ...
        <li class="masonry-item">
            <div class="widget">
                <div class="widget-content padding-30 bg-brown-600 clearfix">
                    <div class="counter counter-md pull-left text-left counter-inverse">
                        <div class="counter-number-group">
                            <span class="counter-number">{{ format_int($a3e['score_sum']) }}</span>
        ...
        <li class="masonry-item">
            <div class="widget">
                <div class="widget-content padding-30 bg-brown-600 clearfix">
                    <div class="counter counter-md pull-left text-left counter-inverse">
                        <div class="counter-number-group">
                            <span class="counter-number">{{ format_float($a3e['kills_sum'] / $a3e['deaths_sum']) }}</span>
                            <span class="counter-number-related text-capitalize">Kills / Deaths</span>
                        </div>
                        <div class="counter-label font-size-16">Exile</div>
                    </div>
                    <div class="pull-right white">
                        <i class="icon icon-3x @if($a3e['kills_sum'] / $a3e['deaths_sum'] > 1) fa-crosshairs @else fa-heartbeat @endif"></i>
                    </div>
                </div>
            </div>
        </li>
