...
|--------------------------------------------------------------------------
|
| This Seeder class allows you to update and create Roles & Permissions for the Laravel Entrust package.
|
...
|--------------------------------------------------------------------------
*/
use A3LWebInterface\User as User;
use A3LWebInterface\Role as Role;
use A3LWebInterface\Permission as Permission;
