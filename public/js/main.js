...
var App = (function () {banner:
  ...
  function leftSidebarInit(){
    ...
    function openSidebar(){
      body.addClass( config.openLeftSidebarClass );
    }
    ...
    /*Open-Sidebar when click on topbar button*/
      $('.am-toggle-left-sidebar').on("click", function(e){
        if( body.hasClass( config.openLeftSidebarClass ) ){
          closeSidebar();
        }else{
          openSidebar();
        }
  ...
  function rightSidebarInit(){
    ...
    function openSidebar(){
      body.addClass( config.openRightSidebarClass );
    }

    function closeSidebar(){
      body.removeClass( config.openRightSidebarClass );
      sidebarDelay();
    }
